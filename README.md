...
外資系コンサルライクなスライドを、Claude in PPTが自動で作成してくれます。
...
完成イメージは以下のようになります。コンサルでよくやる「PPT組込みの表を使わないオブジェクトによる表現」も自動的に実施します。
<img src="assets/sample-slide-1.png" width="450">
<img src="assets/sample-slide-2.png" width="450">
